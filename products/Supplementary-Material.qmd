...
```{r}
#| label: Table1
#| tbl-cap: "Table 1. Unadjusted hazard ratio and 95% confidence interval for time to death (all-cause mortality) among males in the U.S. with prostate cancer (SEER database)."
#| echo: FALSE
library(here)
library(knitr)
Table1 <- readRDS(here("results/tables/simple_model_table_hr.rds"))
kable(Table1)
```

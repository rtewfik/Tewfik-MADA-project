...
## Survival by "education"
summary(survfit(Surv(survival_time, death) ~ education), times <- c(12, 60, 120))

## Survival by "family_history"
summary(survfit(Surv(survival_time, death) ~ family_history), times <- c(12, 60, 120))
```

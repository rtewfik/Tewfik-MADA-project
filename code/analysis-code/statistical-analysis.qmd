...
The results from the model fitting using only "ethnicity" as the predictor ("simple_model_table.rds") can be found in the "tables" folder.
...
The results from the model fitting using "ethnicity", "agegroup", and "stage" as the predictors ("full_model_table.rds") can be found in the "tables" folder.

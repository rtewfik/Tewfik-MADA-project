...
The raw dataset has 1,048,575 observations and 5 variables: "race", "age", "stage", "survival_months", and "vital_status". All variables are character class.
...
# Convert the variables "ethnicity", "agegroup", "stage", and "death" to factor class
...
# Keep only the following variables in the new dataset: "ethnicity", "agegroup", "stage", "survival_time",  and "death"
seer <- subset(seer2, select = c(ethnicity, agegroup, stage, survival_time, death))
